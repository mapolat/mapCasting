...
$a = array(
    ...
    "mapCasting" => "mapCasting 1.0.0 - Copyright &copy; 2012 <a class='nmenulink' title='mapCasting Home' href='http://www.mapolat.p7.de/mapCasting/' target='_bkank'>&nbsp;M. Ayhan POLAT&nbsp;</a>. All rights reserved.",
    ...
    "new_entry" => "Registraione � stato aggiunto con successo.",
    "entry_exist" => "Registraione � gia esistente.",
    "entry_changed" => "Registraione � stato modificato con successo.",
    "entry_deleted" => "Registraione � stato cancellato con successo.",
    ...
    "invoice_issued" => "Questo registraione � stato gia fattura / offerta.",
    ...
    "session_end" => "La seduta � tolta. Per lungo tempo non � stata fatta una digitazione.",
    ...
    "email_ok" => "E-Mail � stata mandata",
    "email_error" => "Errore: E-Mail non � stata mandata.",
    ...
    "payment_incorrect" => "Un versamento pi� alto non � possibile.<br /><br />Versamento deve corrispondere alla somma della fattura.",
    ...
    "cashbook_expenditures" => "Non puo spendere pi� soldi che esistono in cassa.",
