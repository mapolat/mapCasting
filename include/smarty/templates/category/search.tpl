    ...
    <tr>
        <td id="td1_20" width="20%" valign="top">
            ...
            <table border="0" width="80%" cellspacing="0" cellpadding="0" summary="Tabelle 4">
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sub"><a accesskey="1" title="{$Category} - {$List}"
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sel"><a accesskey="3" title="{$Category} - {$Search}"
            ...
            <form id="Search" name="Search" action="searchlist.php?{$Session}" method="post">
                <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                    ...
                    <tr>
                        ...
                        <td class="dbTxt" valign="middle" align="left" width="60%"><input title="{$Category}"
                                                                                          type="text"
                                                                                          name="Description_1" size="30"
                                                                                          value=""/></td>
                    </tr>
                    <tr>
                        <td></td>
