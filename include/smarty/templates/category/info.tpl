    ...
    <tr>
        ...
        <td width="78%" valign="top" align="center">
            ...
            <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                ...
                <tbody>
                <tr>
                    <td align="center" colspan="2"><h2>{$Category} - {$Info}</h2></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
                ...
                <tr>
                    <td align="center" colspan="2">
                        [&nbsp;<a title="{$Editentry}" class="nmenulink"
                                  href="edit.php?categoryID={$categoryID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">{$Edit}</a>
                        &nbsp;|&nbsp;<a title="{$Deleteentry}" class="nmenulink"
                                        href="delete.php?categoryID={$categoryID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">{$Delete}</a>&nbsp;]
                    </td>
                </tr>
                {/if}
                <tr>
                ...
                <tr>
                    <td align="center" colspan="2">{$AllInformation} {$EntryNo} {$categoryID}</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
                <tr>
                    <td valign="middle" align="right" width="40%">{$Category}:&nbsp;</td>
                    <td class="dbTxt" valign="middle" align="left" width="60%">{$CATEGORY}</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
