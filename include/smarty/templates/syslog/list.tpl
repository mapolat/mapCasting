    ...
    <tr>
        <td id="td1_20" width="20%" valign="top">
            ...
            <table border="0" width="80%" cellspacing="0" cellpadding="0" summary="Tabelle 4">
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sel"><a accesskey="1" title="{$Syslog} - {$List}"
                                                                     href="list.php?{$Session}">{$Syslog}</a></td>
                </tr>
        ...
        <td width="78%" valign="top" align="center">
            <table width="100%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                ...
                <tbody>
                <tr>
                    <td align="center" colspan="5"><h2>{$Syslog} - {$List}</h2></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr class="mblueTD">
                    <td nowrap="nowrap" align="left">{$EntryNo}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=SYSLOGID&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC"
                                alt="{$SortMsg} {$EntryNo} ASC"/></a>
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=SYSLOGID&amp;Sort=DESC&amp;{$Session}"><img
                                border="0" src="../images/down.png" title="{$SortMsg} {$EntryNo} DESC"
                                alt="{$SortMsg} {$EntryNo} DESC"/></a>
                    </td>
                    <td nowrap="nowrap" align="left">{$Syslog_Created}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CREATED&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$Syslog_Created} ASC"
                                alt="{$SortMsg} {$Syslog_Created} ASC"/></a>
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=CREATED&amp;Sort=DESC&amp;{$Session}"><img
                                border="0" src="../images/down.png" title="{$SortMsg} {$Syslog_Created} DESC"
                                alt="{$SortMsg} {$Syslog_Created} DESC"/></a>
                    </td>
                    <td nowrap="nowrap" align="left">{$Syslog_Description}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$Syslog_Description} ASC"
                                alt="{$SortMsg} {$Syslog_Description} ASC"/></a>
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;{$Session}"><img
                                border="0" src="../images/down.png" title="{$SortMsg} {$Syslog_Description} DESC"
                                alt="{$SortMsg} {$Syslog_Description} DESC"/></a>
                    </td>
                ...
                ,wTD"}">
                <td valign="top" align="left"><a name="{$syslog.SYSLOGID}"
                                                 title="{$AllInformation} {$EntryNo} {$syslog.SYSLOGID} - {$syslog.DESCRIPTION}"
                                                 class="ninfolink"
                                                 href="info.php?syslogID={$syslog.SYSLOGID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">
                    {if $syslog.SYSLOGID}
                    {$syslog.SYSLOGID}
                    {else}
                    &nbsp;i&nbsp;
                ...
                <td valign="top" align="left" colspan="2">{$syslog.DESCRIPTION|nl2br}</td>
                </tr>
                {/foreach}
                {/if}
                <tr>
