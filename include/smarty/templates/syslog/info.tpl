    ...
    <tr>
        ...
        <td width="78%" valign="top" align="center">
            ...
            <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                ...
                <tbody>
                <tr>
                    <td align="center" colspan="2"><h2>{$Syslog} - {$Info}</h2></td>
                </tr>
                <tr>
                    <td></td>
                </tr>
                <tr>
                    <td align="center" colspan="2">{$AllInformation} {$EntryNo} {$syslogID}</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
                <tr>
                    <td valign="middle" align="right" width="40%">{$Syslog_Created}:</td>
                    <td class="dbTxt" valign="middle" align="left" width="60%">{$SYSLOG_CREATED}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$Syslog_Description}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$SYSLOG_DESCRIPTION|nl2br}</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
