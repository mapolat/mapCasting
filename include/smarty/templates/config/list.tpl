    ...
    <tr>
        ...
        <td width="78%" valign="top" align="center">
            <table width="100%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                ...
                <tbody>
                <tr>
                    <td align="center" colspan="5"><h2>{$Settings} - {$List}</h2></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr class="mblueTD">
                    <td nowrap="nowrap" align="left">
                        &nbsp;{$CompanyName}&nbsp;
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY_NAME&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$CompanyName} ASC"
                                alt="{$SortMsg} {$CompanyName} ASC"/></a>&nbsp;<a
                            href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY_NAME&amp;Sort=DESC&amp;{$Session}"><img
                            border="0" src="../images/down.png" title="{$SortMsg} {$CompanyName} DESC"
                            alt="{$SortMsg} {$CompanyName} DESC"/></a>&nbsp;</td>
                    <td nowrap="nowrap" align="right">{$CompanyPhone}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY_PHONE&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$CompanyPhone} ASC"
                                alt="{$SortMsg} {$CompanyPhone} ASC"/></a>&nbsp;<a
                                href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY_PHONE&amp;Sort=DESC&amp;{$Session}"><img
                                border="0" src="../images/down.png" title="{$SortMsg} {$CompanyPhone} DESC"
                                alt="{$SortMsg} {$CompanyPhone} DESC"/></a>&nbsp;</td>
                    <td nowrap="nowrap" align="right">{$CompanyEmail}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY_EMAIL&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$CompanyEmail} ASC"
                                alt="{$SortMsg} {$CompanyEmail} ASC"/></a>&nbsp;<a
                                href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=COMPANY_EMAIL&amp;Sort=DESC&amp;{$Session}"><img
                                border="0" src="../images/down.png" title="{$SortMsg} {$CompanyEmail} DESC"
                                alt="{$SortMsg} {$CompanyEmail} DESC"/></a>&nbsp;</td>
                ...
                ,wTD"}">
                <td valign="top" align="left"><a name="{$setting.SETTINGID}"
                                                 title="{$AllInformation} {$setting.COMPANY_NAME}" class="ninfolink"
                                                 href="info.php?settingID={$setting.SETTINGID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$setting.COMPANY_NAME|nl2br}</a>
                </td>
                <td valign="top" align="right">{$setting.COMPANY_PHONE}</td>
                <td valign="top" align="right">{$setting.COMPANY_EMAIL}</td>
                <td valign="top" align="center"><a
                        href="edit.php?settingID={$setting.SETTINGID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img
