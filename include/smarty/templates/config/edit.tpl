...
<td width="78%" valign="top" align="center">
    ...
    <form id="Edit" name="Edit" action="editf.php?{$Session}" method="post">
        <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                        ...
                        <tr>
                            <td align="center">
                                [&nbsp;<a title="{$Basic_Settings}" class="nmenulink"
                                          href="edit.php?settingID={$settingID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><b>{$Basic_Settings}</b></a>&nbsp;]
                            </td>
                            <td align="center">
            ...
            <tr>
                <td valign="middle" align="right" width="40%">{$Print_Company_Data}:</td>
                <td valign="middle" align="left" width="60%"><select title="{$Print_Company_Data}"
                                                                     class="choice200"
                                                                     name="D_Print_Company_Data">
            ...
            <tr>
                <td valign="middle" align="right" width="40%">{$Print_Position_Name}:</td>
                <td valign="middle" align="left" width="60%"><select title="{$Print_Position_Name}"
                                                                     class="choice200"
                                                                     name="D_Print_Position_Name">
            ...
            <tr>
                <td valign="middle" align="right" width="40%">{$Email_Internal}:</td>
                <td valign="middle" align="left" width="60%"><select title="{$Email_Internal}" class="choice200"
                                                                     name="D_Email_Internal">
            ...
            <tr>
                <td valign="middle" align="right" width="40%">{$Email_Use_Signature}:</td>
                <td valign="middle" align="left" width="60%"><select title="{$Email_Use_Signature}"
                                                                     class="choice200"
                                                                     name="D_Email_Use_Signature">
            ...
            <tr>
                ...
                <td valign="top" align="left" width="60%"><textarea title="{$Email_Signature}"
                                                                    class="form_textarea"
                                                                    name="D_Email_Signature" rows="7" cols="47">{$D_Email_Signature}</textarea>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            ...
            <tr>
                <td valign="middle" align="right" width="40%">{$Use_Reminder}:</td>
                <td valign="middle" align="left" width="60%"><select title="{$Use_Reminder}" class="choice200"
                                                                     name="D_Reminder">
            ...
            <tr>
                <td valign="middle" align="right" width="40%">{$Reminder_Days}:</td>
                <td valign="middle" align="left" width="60%"><input title="{$Reminder_Days}" class="form_input"
                                                                    name="D_Reminder_Days" size="36"
                                                                    value="{$D_Reminder_Days}"/></td>
            </tr>
            <tr>
                <td valign="middle" align="right" width="40%"><b>{$Entries_Per_Page}</b>:</td>
                <td valign="middle" align="left" width="60%"><input title="{$Entrys_Per_Page}"
                                                                    class="form_input" name="D_Entries_Per_Page"
                                                                    size="36" value="{$D_Entries_Per_Page}"/>
                </td>
            </tr>
            <tr>
                <td valign="middle" align="right" width="40%"><b>{$Session_Sec}</b>:</td>
                <td valign="middle" align="left" width="60%"><input title="{$Session_Sec}" class="form_input"
                                                                    name="D_Session_Sec" size="36"
                                                                    value="{$D_Session_Sec}"/></td>
            </tr>
            <tr>
                <td></td>
            </tr>
