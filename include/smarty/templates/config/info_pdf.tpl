            ...
            <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                ...
                <tr>
                    <td align="center" colspan="2">{$AllInformation} {$EntryNo} {$settingID} [&nbsp;<a
                            ...
                            href="edit_pdf.php?settingID={$settingID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$Edit}</a>&nbsp;]
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                            ...
                            <tr>
                                ...
                                <td align="center">
                                    [&nbsp;<a title="{$PDF_Settings} - {$Info}" class="nmenulink"
                                              href="info_pdf.php?settingID={$settingID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><b>{$PDF_Settings}</b></a>&nbsp;]
                                </td>
                            </tr>
                            </tbody>
                        </table>
                ...
                <tr>
                    <td valign="top" align="right" width="40%">{$Company_Logo}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$CompanyLogo}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$Company_Logo_Width}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$CompanyLogoWidth}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$Company_Logo_Height}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$CompanyLogoHeight}</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$PDF_Font}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$PDFFont}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$PDF_Text1}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$PDFText1}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$PDF_Text2}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$PDFText2}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$PDF_Text3}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$PDFText3}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$PDF_Directory}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$PDFDirectory}</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="40%">{$PDF_Attachment_Text}:</td>
                    <td class="dbTxt" valign="top" align="left" width="60%">{$PDFAttachmentText|nl2br}</td>
                </tr>
                <tr>
                    <td></td>
                </tr>
