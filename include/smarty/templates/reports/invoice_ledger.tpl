...
<tr>
    <td valign="middle" align="left" colspan="6">
        ...
        [&nbsp;<a title="{$PrintMsg} - {$SearchResult} - {$DateFrom} {$Date_Till} {$DateTill}"
                  class="ninfolink"
                  href="pdf/print_pdf.php?DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Type=Invoice_Ledger&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"
...
<tr>
    <td align="center" colspan="6">
        {if $CurrentPage > 1 }
        <a href="{$smarty.server.PHP_SELF}?page=1&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}"><img
                border="0" src="../images/first.png" title="{$FirstPageMsg}" alt="{$FirstPageMsg}"/></a>&nbsp;
        <a href="{$smarty.server.PHP_SELF}?page={$PrevPage}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}"><img
        ...
        {$PageMsg}&nbsp;<a title="{$PageMsg} {$CurrentPage} / {$MaxPages}" class="ninfolink"
                           href="{$smarty.server.PHP_SELF}?page={$CurrentPage}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}">{$CurrentPage}</a>&nbsp;/&nbsp;{$MaxPages}&nbsp;
        {if $CurrentPage < $MaxPages }
        <a href="{$smarty.server.PHP_SELF}?page={$NextPage}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}"><img
                border="0" src="../images/next.png" title="{$NextPageMsg}" alt="{$NextPageMsg}"/></a>&nbsp;
        <a href="{$smarty.server.PHP_SELF}?page={$MaxPages}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Canceled={$Canceled}&amp;{$Session}"><img
...
<tr class="mblueTD">
    <td nowrap="nowrap" align="left">&nbsp;{$Invoice_No}
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.INVOICEID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
                border="0" src="../images/up.png" title="{$SortMsg} {$Invoice_No} ASC"
                alt="{$SortMsg} {$Invoice_No} ASC"/></a>
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.INVOICEID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
    ...
    <td nowrap="nowrap" align="left">{$Customer}
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=A.LASTNAME,A.FIRSTNAME,A.COMPANY&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
                border="0" src="../images/up.png" title="{$SortMsg} {$Customer} ASC"
                alt="{$SortMsg} {$Customer} ASC"/></a>
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=A.LASTNAME,A.FIRSTNAME,A.COMPANY&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
                border="0" src="../images/down.png" title="{$SortMsg} {$Customer} DESC"
                alt="{$SortMsg} {$Customer} DESC"/></a>
    </td>
    <td nowrap="nowrap" align="center">{$DateMsg}
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.INVOICE_DATE&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
                border="0" src="../images/up.png" title="{$SortMsg} {$DateMsg} ASC"
                alt="{$SortMsg} {$DateMsg} ASC"/></a>
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.INVOICE_DATE&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
    ...
    <td nowrap="nowrap" align="right">{$Invoice_Amount} {$Invoice_Currency}
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.TOTAL_AMOUNT&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
                border="0" src="../images/up.png" title="{$SortMsg} {$Invoice_Amount} ASC"
                alt="{$SortMsg} {$Invoice_Amount} ASC"/></a>
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.TOTAL_AMOUNT&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
    ...
    <td nowrap="nowrap" align="right">{$Open_Account}
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.TOTAL_AMOUNT-I.SUM_PAID&amp;Sort=ASC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
                border="0" src="../images/up.png" title="{$SortMsg} {$Open_Account} ASC"
                alt="{$SortMsg} {$Open_Account} ASC"/></a>
        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=I.TOTAL_AMOUNT-I.SUM_PAID&amp;Sort=DESC&amp;Canceled={$Canceled}&amp;DateFrom={$DateFrom}&amp;DateTill={$DateTill}&amp;Report={$Report}&amp;{$Session}"><img
