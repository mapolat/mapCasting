    ...
    <tr>
        ...
        <td width="78%" valign="top" align="center">
            <table width="100%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                ...
                <tbody>
                <tr>
                    <td align="center" colspan="5"><h2>{$PositionGroupSub} - {$List}</h2></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td align="center" colspan="4" class="greentxt">{$EntryChanged} {$EntryNo} {$posgroupID}</td>
                </tr>
                {/if}
                {if $smarty.session.DeleteID and ( $smarty.session.DeleteID eq 1 )}
                <tr>
                    <td align="center" colspan="4" class="greentxt">{$EntryDeleted} {$EntryNo} {$posgroupID}</td>
                </tr>
                {/if}
                <tr>
                    <td></td>
                ...
                <tr class="mblueTD">
                    <td nowrap="nowrap" align="left">{$EntryNo}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POSGROUPID&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC"
                                alt="{$SortMsg} {$EntryNo} ASC"/></a>&nbsp;<a
                                href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=POSGROUPID&amp;Sort=DESC&amp;{$Session}"><img
                    ...
                    <td nowrap="nowrap" align="left">{$PositionGroupSub}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$PositionGroupSub} ASC"
                                alt="{$SortMsg} {$PositionGroupSub} ASC"/></a>&nbsp;<a
                                href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;{$Session}"><img
                                border="0" src="../images/down.png" title="{$SortMsg} {$PositionGroupSub} DESC"
                                alt="{$SortMsg} {$PositionGroupSub} DESC"/></a>&nbsp;</td>
                ...
                ,wTD"}">
                <td valign="top" align="left"><a name="{$posgroup.POSGROUPID}"
                                                 title="{$AllInformation} {$EntryNo} {$posgroup.POSGROUPID} - {$posgroup.DESCRIPTION}"
                                                 class="ninfolink"
                                                 href="info.php?posgroupID={$posgroup.POSGROUPID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">
                    {$posgroup.POSGROUPID}</a></td>
                <td valign="top" align="left">
                    {$posgroup.DESCRIPTION}
                </td>
                ...
                <td valign="top" align="center"><a
                        href="edit.php?posgroupID={$posgroup.POSGROUPID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img
