    ...
    <tr>
        <td id="td1_20" width="20%" valign="top">
            ...
            <table border="0" width="80%" cellspacing="0" cellpadding="0" summary="Tabelle 4">
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sub"><a accesskey="1" title="{$PositionGroupSub} - {$List}"
                                                                     href="list.php?{$Session}">{$PositionGroupSub}</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="mapcasting_menu_sel"><a accesskey="2" title="{$PositionGroupSub} - {$New}"
        ...
        <td width="78%" valign="top" align="center">
            ...
            <form id="New" name="New" action="newf.php?{$Session}" method="post">
                <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                    ...
                    <tr>
                        <td align="center" colspan="2"><h2>{$PositionGroupSub} - {$New}</h2></td>
                    </tr>
                    {if $smarty.session.NewID and ( $smarty.session.NewID eq 1 )}
                    <tr>
                        <td align="center" colspan="2" class="greentxt">{$NewEntry} {$EntryNo} {$PosGroupID}</td>
                    </tr>
                    {/if}
                    <tr>
                        <td></td>
                    ...
                    <tr>
                        <td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$PosGroupID+1} ]</td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
