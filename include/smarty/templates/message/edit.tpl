                ...
                <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                    ...
                    <tr>
                        <td valign="middle" align="left" colspan="2">
                            {if $infoID eq 9}
                            [&nbsp;<a title="{$BackMsg} - {$Message} - {$Searchresult}" class="ninfolink"
                    ...
                    <tr>
                        <td align="center" colspan="2"><h2>{$Message} - {$Edit}</h2></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$messageID} ]</td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
