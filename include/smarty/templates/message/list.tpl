    ...
    <tr>
        ...
        <td width="78%" valign="top" align="center">
            <table width="100%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                ...
                <tbody>
                <tr>
                    <td align="center" colspan="5"><h2>{$Message} - {$List}</h2></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr>
                    <td align="center" colspan="4" class="greentxt">{$EntryChanged} {$EntryNo} {$messageID}</td>
                </tr>
                {/if}
                {if $smarty.session.DeleteID and ( $smarty.session.DeleteID eq 1 )}
                <tr>
                    <td align="center" colspan="4" class="greentxt">{$EntryDeleted} {$EntryNo} {$messageID}</td>
                </tr>
                {/if}
                <tr>
                    <td></td>
                ...
                <tr class="mblueTD">
                    <td nowrap="nowrap" align="left">{$EntryNo}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC"
                                alt="{$SortMsg} {$EntryNo} ASC"/></a>&nbsp;<a
                                href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=DESC&amp;{$Session}"><img
                    ...
                    <td nowrap="nowrap" align="left">{$Message}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=ASC&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$Message} ASC"
                                alt="{$SortMsg} {$Message} ASC"/></a>&nbsp;<a
                                href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=DESCRIPTION&amp;Sort=DESC&amp;{$Session}"><img
                                border="0" src="../images/down.png" title="{$SortMsg} {$Message} DESC"
                                alt="{$SortMsg} {$Message} DESC"/></a>&nbsp;</td>
                ...
                ,wTD"}">
                <td valign="top" align="left"><a name="{$message.MESSAGEID}"
                                                 title="{$AllInformation} {$EntryNo} {$message.MESSAGEID} - {$message.DESCRIPTION}"
                                                 class="ninfolink"
                                                 href="info.php?messageID={$message.MESSAGEID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">
                    {$message.MESSAGEID}</a></td>
                ...
                <td valign="top" align="center"><a
                        href="edit.php?messageID={$message.MESSAGEID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img
