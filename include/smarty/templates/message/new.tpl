    ...
    <tr>
        <td id="td1_20" width="20%" valign="top">
            ...
            <table border="0" width="80%" cellspacing="0" cellpadding="0" summary="Tabelle 4">
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sel"><a accesskey="2" title="{$Message} - {$New}"
                ...
                <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                    ...
                    <tr>
                        <td valign="middle" align="left" colspan="2">
                            [&nbsp;<a title="{$BackMsg} - {$Message} - {$List}" class="ninfolink"
                                      href="list.php?page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
                        </td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2"><h2>{$Message} - {$New}</h2></td>
                    </tr>
                    {if $smarty.session.NewID and ( $smarty.session.NewID eq 1 )}
                    <tr>
                        <td align="center" colspan="2" class="greentxt">{$NewEntry} {$EntryNo} {$MessageID}</td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
                    {/if}
                    <tr>
                        <td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$MessageID+1} ]</td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
                    ...
                    <tr>
                        <td valign="middle" align="center" colspan="2"><textarea title="{$Message}"
                                                                                 class="form_textarea" name="CMessage"
                                                                                 rows="5"
                                                                                 cols="40">{$CMessage}</textarea></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
