    ...
    <tr>
        ...
        <td width="78%" valign="top" align="center">
            <table width="100%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                ...
                <tbody>
                <tr>
                    <td align="center" colspan="5"><h2>{$Message} - {$Searchresult}</h2></td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
                ...
                <tr class="mblueTD">
                    <td nowrap="nowrap" align="left">{$EntryNo}
                        <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=ASC&amp;Description_1={$Description_1}&amp;{$Session}"><img
                                border="0" src="../images/up.png" title="{$SortMsg} {$EntryNo} ASC"
                                alt="{$SortMsg} {$EntryNo} ASC"/></a>&nbsp;<a
                                href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=MESSAGEID&amp;Sort=DESC&amp;Description_1={$Description_1}&amp;{$Session}"><img
                ...
                {if $MaxRows == 0}
                <tr>
                    <td align="center" colspan="5" class="grayTD">{$NoEntry}</td>
                </tr>
                {else}
                ...
                <td valign="top" align="left"><a name="{$message.MESSAGEID}"
                                                 ...
                                                 class="ninfolink"
                                                 href="info.php?messageID={$message.MESSAGEID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}">
                ...
                <td valign="top" align="center"><a
                        href="edit.php?messageID={$message.MESSAGEID}&amp;infoID=9&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;Description_1={$Description_1}&amp;{$Session}"><img
