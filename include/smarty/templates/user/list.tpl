...
<tr>
    ...
    <td width="78%" valign="top" align="center">
        <table width="100%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
            ...
            <tbody>
            <tr>
                <td align="center" colspan="5"><h2>{$Useradministration} - {$List}</h2></td>
            </tr>
            <tr>
                <td>&nbsp;</td>
            </tr>
            ...
            <tr class="mblueTD">
                <td nowrap="nowrap" align="left">{$Full_Name}
                    <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=FULLNAME&amp;Sort=ASC&amp;{$Session}"><img
                            border="0" src="../images/up.png" title="{$SortMsg} {$Full_Name} ASC"
                            alt="{$SortMsg} {$Full_Name} ASC"/></a>&nbsp;<a
                            href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=FULLNAME&amp;Sort=DESC&amp;{$Session}"><img
                ...
                <td nowrap="nowrap" align="left">{$Language}
                    <a href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=LANGUAGE&amp;Sort=ASC&amp;{$Session}"><img
                            border="0" src="../images/up.png" title="{$SortMsg} {$Language} ASC"
                            alt="{$SortMsg} {$Language} ASC"/></a>&nbsp;<a
                            href="{$smarty.server.PHP_SELF}?{$AddCurrentPage}Order=LANGUAGE&amp;Sort=DESC&amp;{$Session}"><img
            ...
            <td valign="top" align="left"><a name="{$user.USERID}"
                                             ...
                                             class="ninfolink"
                                             href="info.php?userID={$user.USERID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">
                {if $user.FULLNAME}
                {$user.FULLNAME}
                {else}
                &nbsp;i&nbsp;
            ...
            <td valign="top" align="center"><a
                    href="edit.php?userID={$user.USERID}&amp;{$AddCurrentPage}Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><img
