        ...
        <td width="78%" valign="top" align="center">
            ...
            <form id="Search" name="Search" action="searchlist.php?{$Session}#{$userID}" method="post">
                <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
                    ...
                    <tr>
                        <td align="center" colspan="2"><h2>{$Useradministration} - {$Search}</h2></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
