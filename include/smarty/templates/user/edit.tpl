        ...
        <table width="80%" border="0" class="mapcasting_tabelle" cellspacing="3" cellpadding="3"
            ...
            <tr>
                <td valign="middle" align="left" colspan="2">
                    [&nbsp;<a title="{$BackMsg} - {$Useradministration} - {$Searchresult}" class="ninfolink"
                              href="searchlist.php?page={$page}&amp;UserActive_1={$UserActive_1}&amp;FullName_1={$FullName_1}&amp;UserName_1={$UserName_1}&amp;UserGroup_1={$UserGroup_1}&amp;UserLanguage_1={$UserLanguage_1}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
                </td>
            </tr>
            {else}
            <tr>
            ...
            {/if}
            <tr>
                <td align="center" colspan="2"><h2>{$Useradministration} - {$Edit}</h2></td>
            </tr>
            <tr>
                <td></td>
            </tr>
            <tr>
                <td align="center" colspan="2" class="dbTxt">[ {$EntryNo} {$userID} ]</td>
            </tr>
            <tr>
                <td></td>
            </tr>
