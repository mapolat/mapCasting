    ...
    <tr>
        <td id="td1_20" width="20%" valign="top">
            ...
            <table border="0" width="80%" cellspacing="0" cellpadding="0" summary="Tabelle 4">
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sel"><a accesskey="4" title="{$Addressbook} - {$Help}"
                                                                     href="help.php?{$Session}">{$Help}</a></td>
                </tr>
                <tr>
                    <td align="left" class="mapcasting_menu"><a accesskey="P" title="{$Position}"
                                                                 href="../position/list.php?{$Session}">{$Position}</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="mapcasting_menu"><a accesskey="O" title="{$Offer}"
                                                                 href="../offer/list.php?{$Session}">{$Offer}</a></td>
                </tr>
                <tr>
                    <td align="left" class="mapcasting_menu"><a accesskey="I" title="{$Invoice}"
                                                                 href="../invoice/list.php?{$Session}">{$Invoice}</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="mapcasting_menu"><a accesskey="M" title="{$Payment}"
                                                                 href="../payment/list.php?{$Session}">{$Payment}</a>
                    </td>
                </tr>
                <tr>
                    <td align="left" class="mapcasting_menu"><a accesskey="C" title="{$Cashbook}"
