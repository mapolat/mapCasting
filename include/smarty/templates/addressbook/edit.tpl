...
<tr>
    <td valign="middle" align="left" colspan="2">
        ...
        {if $Type eq "Info"}
        [&nbsp;<a title="{$BackMsg} - {$Addressbook} - {$Basic_Info}"
                  class="ninfolink"
                  href="info.php?myID={$myID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Customer={$Customer}{$Searchstring}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
        {elseif $infoID eq 9}
...
<tr>
    <td align="center" colspan="2">
        [&nbsp;<a title="{$Basic_Info}"
                  class="nmenulink"
                  href="edit.php?myID={$MYID}&amp;infoID={$infoID}&amp;page={$page}&amp;Type={$Type}&amp;Customer={$Customer}{$Searchstring}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><b>{$Basic_Info}</b></a>&nbsp;]
        &nbsp;
        ...
        [&nbsp;<a title="{$Auth_Info}"
                  class="nmenulink"
                  href="edit_a.php?myID={$MYID}&amp;infoID={$infoID}&amp;page={$page}&amp;Type={$Type}&amp;Customer={$Customer}{$Searchstring}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$Auth_Info}</a>&nbsp;]
    </td>
</tr>
...
<tr>
    <td valign="middle" align="right" width="30%">{$DateMsg}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">{$CREATED}</td>
</tr>

<tr>
    <td valign="middle" align="right" width="30%">{$Print_Name}:</td>
...
<tr>
    <td valign="middle" align="right" width="30%"><b>{$Prefix}</b>:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input title="{$Prefix}" class="form_input" type="text" name="Prefix" size="22" value="{$PREFIX}"/></td>
</tr>

<tr>
    <td valign="middle" align="right" width="30%">{$CTitle}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input title="{$CTitle}" class="form_input" type="text" name="Title1" size="22" value="{$TITLE}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%"><b>{$Firstname}</b>:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input title="{$Firstname}" class="form_input" type="text" name="Firstname" size="22" value="{$FIRSTNAME}"/>
    </td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%"><b>{$Lastname}</b>:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Lastname" size="22" value="{$LASTNAME}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Initials}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input title="{$Initials}" class="form_input" type="text" name="Initials" size="22" value="{$INITIALS}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Company}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Company" size="22" value="{$COMPANY}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Department}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Department" size="22" value="{$DEPARTMENT}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$CPosition}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Position1" size="22" value="{$POSITION}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Salutation}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Salutation" size="22" value="{$SALUTATION}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%"><b>{$Address}</b>:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Address" size="22" value="{$ADDRESS}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%"><b>{$Postalcode}</b>:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Postalcode" size="22" value="{$POSTALCODE}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%"><b>{$City}</b>:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="City" size="22" value="{$CITY}"/>
    </td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Stateprov}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Stateprov" size="22" value="{$STATEPROV}"/></td>
</tr>

<tr>
    <td valign="middle" align="right" width="30%"><b>{$Country}</b>:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Country" size="22" value="{$COUNTRY}"/></td>
</tr>
...
<tr>
    <td valign="middle" align="right" width="30%">{$Category}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <select class="choice200" name="Category" title="{$Category}">
            <optgroup label="{$Category}" title="{$Category}">
                ...
                <option label="{$category.DESCRIPTION}" title="{$category.DESCRIPTION}" value="{$category.CATEGORYID}"
                        selected="selected">
...
<tr>
    <td valign="middle" align="right" width="30%">{$CustMessage}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <select class="choice200" name="Message" title="{$CustMessage}">
            <optgroup label="{$CustMessage}" title="{$CustMessage}">
                ...
                <option label="{$message.DESCRIPTION}" title="{$message.DESCRIPTION}" value="{$message.MESSAGEID}"
                        selected="selected">
                    {$message.DESCRIPTION}
                </option>
                {else}
...
<tr>
    ...
    <td class="dbTxt" valign="top" align="left" width="70%">
        <textarea class="form_textarea" name="Note" rows="5" cols="20">{$NOTE}</textarea></td>
</tr>

<tr>
    <td valign="middle" align="right" width="30%">{$Birthday}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%">
        <input class="form_input" type="text" name="Birthday" size="22" value="{if $BIRTHDAY neq 0}{$BIRTHDAY}{/if}"/>
    </td>
</tr>
<tr>
    <td>&nbsp;</td>
