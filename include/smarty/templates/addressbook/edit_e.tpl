...
<tr>
    <td valign="middle" align="left" colspan="2">
        {if $Type eq "Info"}
        [&nbsp;<a title="{$BackMsg} - {$Addressbook} - {$Extended_Info}" class="ninfolink"
                  href="info_e.php?myID={$myID}&amp;infoID={$infoID}&amp;page={$page}&amp;Order={$Order}&amp;Sort={$Sort}&amp;Customer={$Customer}{$Searchstring}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
        {elseif $infoID eq 9}
...
<tr>
    <td align="center" colspan="2">
        ...
        [&nbsp;<a title="{$Extended_Info}" class="nmenulink"
                  href="edit_e.php?myID={$MYID}&amp;infoID={$infoID}&amp;page={$page}&amp;Type={$Type}&amp;Customer={$Customer}{$Searchstring}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><b>{$Extended_Info}</b></a>&nbsp;]
        &nbsp;
...
<tr>
    <td valign="middle" align="right" width="30%">{$Phonehome}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Phonehome" size="22"
                                                                   value="{$PHONEHOME}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Mobile}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Mobile" size="22"
                                                                   value="{$MOBILE}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Fax}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Fax" size="22"
                                                                   value="{$FAX}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Phonework}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Phonework" size="22"
                                                                   value="{$PHONEWORK}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Phoneoffi}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Phoneoffi" size="22"
                                                                   value="{$PHONEOFFI}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Phoneothe}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Phoneothe" size="22"
                                                                   value="{$PHONEOTHE}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Pager}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Pager" size="22"
                                                                   value="{$PAGER}"/></td>
</tr>
...
<tr>
    <td valign="middle" align="right" width="30%">{$Email}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Email" size="22"
                                                                   value="{$EMAIL}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Email2}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Email2" size="22"
                                                                   value="{$EMAIL2}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Url}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Url" size="22"
                                                                   value="{$URL}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Url2}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="Url2" size="22"
                                                                   value="{$URL2}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$AltField1}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="AltField1" size="22"
                                                                   value="{$ALTFIELD1}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$AltField2}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="AltField2" size="22"
                                                                   value="{$ALTFIELD2}"/></td>
</tr>
<tr>
    <td>&nbsp;</td>
...
<tr>
    ...
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="D_Taxnr" size="22"
                                                                   value="{$TAXNR}"/></td>
</tr>
<tr>
    <td valign="middle" align="right" width="30%">{$Business_Tax_No}:</td>
    <td class="dbTxt" valign="top" align="left" width="70%"><input class="form_input" type="text"
                                                                   name="D_Business_Taxnr" size="22"
                                                                   value="{$BUSINESS_TAXNR}"/></td>
</tr>
<tr>
    <td>&nbsp;</td>
</tr>
