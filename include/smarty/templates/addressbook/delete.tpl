            ...
            <table border="0" width="80%" cellspacing="0" cellpadding="0" summary="Tabelle 4">
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sel">
                        <a accesskey="A" title="{$Addressbook} - {$List}" href="list.php?{$Session}">{$Addressbook}</a>
                    </td>
                </tr>
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sub">
                        <a accesskey="2" title="{$Addressbook} - {$Search}" href="search.php?{$Session}">{$Search}</a>
                    </td>
                </tr>

                <tr>
                    <td align="left" class="mapcasting_menu_sub">
                        <a accesskey="3" title="{$Addressbook} - {$DetailSearch}" href="search_e.php?{$Session}">{$DetailSearch}</a>
                    </td>
                </tr>
        ...
        <td width="78%" valign="top" align="center">
            ...
            <form id="Search" name="Search" action="deletef.php?{$Session}" method="post">
                <table width="80%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                    ...
                    <tr>
                        <td align="center" colspan="2"><h2>{$Addressbook} - {$Delete}</h2></td>
                    </tr>
                    ...
                    <tr>
                        <td valign="middle" align="center" colspan="2">{$Customer_No} {$myID}, {$FIRSTNAME} {$LASTNAME}
                            {$COMPANY} ?
                        </td>
                    </tr>
