    ...
    <tr>
        <td id="td1_20" width="20%" valign="top">
            ...
            <table border="0" width="80%" cellspacing="0" cellpadding="0" summary="Tabelle 4">
                ...
                <tr>
                    <td align="left" class="mapcasting_menu_sel"><a accesskey="2" title="{$Addressbook} - {$Search}"
        ...
        <td width="78%" valign="top" align="center">
            <form id="Search" name="Search" action="searchlist.php?{$Session}" method="post">
                ...
                <table width="80%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                    ...
                    <tr>
                        <td align="center" colspan="2"><h2>{$Addressbook} - {$Search}</h2></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" width="30%">{$Search}:</td>
                        <td class="dbTxt" valign="top" align="left" width="70%">
                            <input class="form_input" type="text" name="Customer" size="40" title="{$FindCustomer}"/>&nbsp;<input
                                type="submit" class="button" title="{$Search}" value="{$Search}"/></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
