                ...
                <table width="80%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                    ...
                    <tr>
                        <td valign="middle" align="left" colspan="2">
                            ...
                            {elseif $infoID eq 10}
                            [&nbsp;<a title="{$BackMsg} - {$Addressbook} - {$Searchresult}" class="ninfolink"
                                      href="searchlist_e.php?page={$page}&amp;Order={$Order}&amp;Sort={$Sort}{$Searchstring}&amp;{$Session}">{$BackMsg}</a>&nbsp;]
                            {else}
                    ...
                    <tr>
                        <td align="center" colspan="2"><h2>{$Addressbook} - {$Email}</h2></td>
                    </tr>
                    <tr>
                        <td></td>
                    </tr>
                    <tr>
                        <td align="center" colspan="2" class="dbTxt">[ {$Customer_No} {$myID} - {$FIRSTNAME} {$LASTNAME}
                            {$COMPANY} ]
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td valign="top" align="right" width="35%">{$Email_From}:&nbsp;</td>
                        <td class="dbTxt" valign="top" align="left" width="65%">{$COMPANYNAME}<br/>[ {$COMPANYEMAIL} ]
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" width="35%"><b>{$Email_To}</b>:&nbsp;</td>
                        <td class="dbTxt" valign="top" align="left" width="65%"><input title="{$Email_To}"
                                                                                       class="form_input" type="text"
                                                                                       name="EmailTo" size="32"
                                                                                       value="{$EMAIL_TO}"/></td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" width="35%">{$Email_Cc}:&nbsp;</td>
                        <td class="dbTxt" valign="top" align="left" width="65%"><input title="{$Email_Cc}"
                                                                                       class="form_input" type="text"
                                                                                       name="EmailCc" size="32"
                                                                                       value="{$EmailCc}"/></td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" width="35%">{$Email_Bcc}:&nbsp;</td>
                        <td class="dbTxt" valign="top" align="left" width="65%"><input title="{$Email_Bcc}"
                                                                                       class="form_input" type="text"
                                                                                       name="EmailBcc" size="32"
                                                                                       value="{$EmailBcc}"/></td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" width="35%"><b>{$Email_Subject}</b>:&nbsp;</td>
                        <td class="dbTxt" valign="top" align="left" width="65%"><input title="{$Email_Subject}"
                                                                                       class="form_input" type="text"
                                                                                       name="EmailSubject" size="32"
                                                                                       value="{$EmailSubject}"/></td>
                    </tr>
                    <tr>
                        <td valign="middle" align="right" width="35%">{$Email_Priority}:&nbsp;</td>
                    ...
                    <tr>
                        <td valign="top" align="right" width="35%"><b>{$Email_Text}</b>:&nbsp;</td>
                        <td class="dbTxt" valign="top" align="left" width="65%"><textarea title="{$Email_Text}"
                                                                                          class="form_textarea"
                                                                                          name="EmailText" rows="10"
                                                                                          cols="46">{$EMAIL_TEXT}</textarea>
                        </td>
                    </tr>
                    <tr>
                        <td>&nbsp;</td>
