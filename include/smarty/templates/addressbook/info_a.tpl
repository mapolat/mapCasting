    ...
    <tr>
        ...
        <td width="78%" valign="top" align="center">
            <table width="80%" class="mapcasting_tabelle" border="0" cellspacing="0" cellpadding="2"
                ...
                <tr>
                    <td align="center" colspan="2">
                        [&nbsp;<a title="{$Editentry}" class="nmenulink"
                                  href="edit_a.php?myID={$MYID}&amp;infoID={$infoID}&amp;page={$page}&amp;Type=Info&amp;Customer={$Customer}{$Searchstring}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}">{$Edit}</a>
                ...
                <tr>
                    <td align="center" colspan="2">
                        ...
                        [&nbsp;<a title="{$Auth_Info}" class="nmenulink"
                                  href="info_a.php?myID={$MYID}&amp;infoID={$infoID}&amp;page={$page}&amp;Customer={$Customer}{$Searchstring}&amp;Order={$Order}&amp;Sort={$Sort}&amp;{$Session}"><b>{$Auth_Info}</b></a>&nbsp;]
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr>
                    <td valign="top" align="right" width="30%">{$User_Active}:</td>
                    <td class="dbTxt" valign="top" align="left" width="70%">{$USERACTIVE}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="30%">{$Username}:</td>
                    <td class="dbTxt" valign="top" align="left" width="70%">{$USERNAME}</td>
                </tr>
                <tr>
                    <td valign="top" align="right" width="30%">{$Language}:</td>
                    <td class="dbTxt" valign="top" align="left" width="70%">{$LANGUAGE}</td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                </tr>
